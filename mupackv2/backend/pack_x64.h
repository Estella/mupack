...
extern PIMAGE_TLS_DIRECTORY64 pImgTlsDir;
extern DWORD tls_callbacksnum;

typedef int(__fastcall *tdefilt) (PVOID, DWORD);
typedef void (_fastcall *tmentry)(LPVOID,LPVOID);
typedef void (_fastcall *trestore)(LPVOID,LPVOID);
typedef void(__fastcall *ttlscallback)(PVOID, DWORD, DWORD);
